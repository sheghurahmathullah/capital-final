...
const SectorsGrid = () => {
  ...
  return (
    <section id="sectors" className={`py-20 bg-gray-50 ${camber.variable}`}>
      <div className="container">
        <div className="mb-12">
          <h2
            className={`text-3xl md:text-4xl font-bold mb-4 font-[--body-font]`}
          >
            Our Sectors
          </h2>
          ...
          {sectors.map((sector, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center p-4">
                <h3
                  className={`text-xl font-bold text-white text-center mb-2 font-[--body-font]`}
                >
                  {sector.title}
                </h3>
