            ...
            >
              ...
              <div className="mt-6 space-y-4 text-lg leading-relaxed text-gray-300">
                <p>
                  ...
                  <strong className="text-white">Mr. Balaskandan Raghunathan</strong>, shares his expert
                  insights on organizational growth, vision, and the impact of
                  leadership in driving success.
                </p>
                <p>
                  Watch as Mr. Raghunathan discusses the journey, challenges, and
                  future prospects, offering a deeper look into the factors that
                  shape a thriving business.
                </p>
                <blockquote className="pl-4 border-l-4 border-blue-400 italic text-blue-200 my-6">
                  "Our commitment to excellence is unwavering. We believe in creating value through innovative thinking and meticulous execution."
                </blockquote>
              </div>
              ...
              <Button
                onClick={handlePlay}
                size="lg"
                className="mt-8 bg-white text-blue-900 hover:bg-blue-50 group"
              >
