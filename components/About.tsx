        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div ref={contentRef} className="w-full lg:w-1/2 opacity-0">
            ...
            >
              ...
              and KSA. We specialize in delivering cutting-edge solutions in
              Engineering Consultancy, Residential & Commercial Design,
              Industrial Developments, and Infrastructure projects.
              <br />
              <br />
