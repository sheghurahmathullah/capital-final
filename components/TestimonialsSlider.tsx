    ...
    <section className="py-24 bg-gradient-to-b from-white to-slate-50">
      <div className="container px-4 mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#211574]">
            Client Testimonials
          </h2>
                          ...
                          <div className="pt-6 border-t border-slate-100 flex items-center justify-between">
                            <div>
                              <div className="flex items-center gap-2">
                                <div className="w-10 h-10 rounded-full bg-gradient-to-r from-[#211574] to-[#4a3cb5] flex items-center justify-center text-white font-bold">
                            ...
                            <div className="text-right">
                              <div className="text-sm font-semibold text-[#211574]">
                                {testimonial.company}
                              </div>
                            </div>
                          </div>
