          ...
          <div className="container">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              ...
              >
                ...
                <p className="text-gray-600">Average Carbon Reduction</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600">LEED Certified Projects</p>
              </motion.div>
            </div>

            <p className="text-center mt-8 text-gray-600">
              Leading sustainable construction practices across the MENA region,
              Europe, and Asia with internationally recognized environmental
              certifications.
            </p>
          </div>
        </section>
