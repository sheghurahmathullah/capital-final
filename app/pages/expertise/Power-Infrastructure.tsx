          ...
          <div className="container">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              ...
              >
                ...
                <p className="text-gray-600">Power Projects Completed</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600">Years of Power Expertise</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600">Renewable Energy Integration</p>
              </motion.div>
            </div>

            <p className="text-center mt-8 text-gray-600">
              Delivering innovative power infrastructure solutions across the
              MENA region, Europe, and Asia with a focus on reliability,
